  ...
  return (
    <div tw="py-16 bg-gray-50 overflow-hidden">
      <div tw="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
        <div tw="text-base mx-auto lg:max-w-none">
        ...
        <div tw="relative z-10 text-base mx-auto lg:max-w-5xl lg:mx-0 lg:pr-72">
          <p tw="text-lg text-gray-500">
            ...
            nunc nisl netus morbi vel porttitor vitae ut. Amet vitae fames senectus vitae.
          </p>
        </div>
        <div tw="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
          <div tw="relative z-10">
            <div tw="text-gray-500 mx-auto lg:max-w-none">
              <p>
            ...
            <div tw="mt-10 flex text-base mx-auto lg:max-w-none">
              <div tw="rounded-md shadow">
                <a
                  href="https://www.linkedin.com/in/rom%C3%A9o-brilland-23074a1a7/"
              ...
              <div tw="rounded-md shadow ml-4">
                <a
                  href="https://github.com/iamRomeo-dev?tab=repositories"
          ...
          <div tw="mt-12 relative text-base mx-auto lg:mt-0 lg:max-w-none">
            <svg
            ...
            <blockquote tw="relative bg-white rounded-lg shadow-lg">
              ...
              <cite tw="relative flex items-center sm:items-start bg-indigo-600 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
                <span tw="relative rounded-full border-2 border-white sm:absolute sm:top-0 sm:transform sm:-translate-y-1/2">
                  <img
                ...
                <span tw="relative ml-4 text-indigo-300 font-semibold leading-6 sm:ml-24 sm:pl-1">
                  <span tw="text-white font-semibold sm:inline">Judith Black</span>{" "}
                  <span tw="sm:inline">CEO at Workcation</span>
                </span>
              </cite>
            </blockquote>
          </div>
